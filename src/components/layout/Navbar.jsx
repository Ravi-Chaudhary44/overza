...
const RunningNavMessage = () => {
  ...
  return (
    <nav className="glass-navbar fixed top-0 left-0 right-0 z-50 border-b border-white/10">
      <RunningNavMessage />
...
/>
            ...
            {user ? (
              <div className="relative">
                ...
                {isProfileMenuOpen && (
                  <GlassWrapper variant="card" rounded="xl" padding="p-2" className="absolute right-0 mt-2 w-48 z-50">
              ...
              <div className="flex items-center space-x-4">
                <GlassButton to="/login" variant="outline" size="sm"
                 glow
...
<GlassButton
  ...
  variant="primary"
  size="sm"
  className="bg-gradient-to-r from-cricket-green to-purple-600 hover:from-cricket-darkGreen hover:to-purple-700 border-none"
   glow
  glowColor="rgba(255, 0, 217, 0.5)" 
>
  Register
</GlassButton>
              </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4">
              <GlassWrapper variant="card" padding="p-4" className="w-full">
